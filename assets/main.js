...
const i18nDict = {
  ...
  // Home
  "Premier International Representation": {
    fr: "Représentation Internationale de Premier Plan",
    ja: "最高の国際的な表現",
  },
  ...
  "Please fill out the details below to apply. Your requirements may change based on your designation.":
    {
      fr: "Veuillez remplir les détails ci-dessous pour postuler. Vos exigences peuvent changer en fonction de votre désignation.",
      ja: "申し込むには以下の詳細を入力してください。 要件は指定によって異なる場合があります。",
    },
  "What is your designation? *": {
    fr: "Quelle est votre désignation ? *",
    ja: "あなたの指定は何ですか？ *",
  },
  "Select an option that best represents you": {
    fr: "Sélectionnez une option qui vous représente le mieux",
    ja: "あなたを最もよく表すオプションを選択してください",
  },
  ...
  "Click to upload (Up to 4 files)": {
    fr: "Cliquez pour télécharger (jusqu'à 4 fichiers)",
    ja: "クリックしてアップロード (最大4ファイル)",
  },
  "Upload Image (Headshot) *": {
    fr: "Télécharger l'Image (Portrait) *",
    ja: "画像のアップロード（顔写真） *",
  },
  "Upload Look Book *": {
    fr: "Télécharger le Look Book *",
    ja: "ルックブックをアップロード *",
  },
  Apply: { fr: "Postuler", ja: "応募する" },
  ...
  "You can only upload a maximum of 4 files.": {
    fr: "Vous ne pouvez télécharger qu'un maximum de 4 fichiers.",
    ja: "アップロードできるファイルは最大4つまでです。",
  },
  ...
  "What are the different types of modeling?": {
    fr: "Quels sont les différents types de mannequinat ?",
    ja: "モデリングのさまざまな種類は何ですか？",
  },
  "What does M Models do for you?": {
    fr: "Que fait M Models pour vous ?",
    ja: "M Modelsはあなたのために何をしますか？",
  },
  "What if I have no experience?": {
    fr: "Et si je n'ai pas d'expérience ?",
    ja: "経験がない場合はどうなりますか？",
  },
  "What should I wear to the interview?": {
    fr: "Que dois-je porter pour l'entrevue ?",
    ja: "面接には何を着ていけばいいですか？",
  },
  "Can M Models guarantee me work?": {
    fr: "M Models peut-elle me garantir du travail ?",
    ja: "M Modelsは仕事の保証をしますか？",
  },
  "Does M Models find work internationally?": {
    fr: "M Models trouve-t-elle du travail à l'international ?",
    ja: "M Modelsは国際的な仕事を見つけますか？",
  },
  "What’s the height requirement?": {
    fr: "Quelle est l'exigence de taille ?",
    ja: "身長の要件は何ですか？",
  },
  ...
  "M Models represents you in front of clienteles.": {
    fr: "M Models vous représente devant les clientèles.",
    ja: "M Modelsは顧客の前であなたを代表します。",
  },
  "M Models handles your bookings.": {
    fr: "M Models gère vos réservations.",
    ja: "M Modelsはあなたの予約を処理します。",
  },
  "M Models Negotiates rates for you with the clientele.": {
    fr: "M Models négocie les tarifs pour vous avec la clientèle.",
    ja: "M Modelsはクライアントとあなたの料金を交渉します。",
  },
  ...
  "ex: myname@example.com": {
    fr: "ex: monnom@exemple.com",
    ja: "例：myname@example.com",
  },
  ...
  "Visit our YOUTUBE CHANNEL": {
    fr: "Visitez notre CHAÎNE YOUTUBE",
    ja: "YOUTUBEチャンネルをご覧ください",
  },
  ...
  "Representing Excellence in Every Frame": {
    fr: "Représenter l'Excellence dans Chaque Image",
    ja: "すべてのフレームで卓越性を表現する",
  },
  Showcase: { fr: "Vitrine", ja: "ショーケース" },
  "Campaign Highlights": {
    fr: "Points Forts de la Campagne",
    ja: "キャンペーンのハイライト",
  },
  OUR: { fr: "NOTRE", ja: "私たちの" },
  WORKS: { fr: "RÉALISATIONS", ja: "実績" },
  "Our Works": { fr: "Showcase", ja: "ショーケース" },
  "Showcase Campaign Highlights": {
  ...
  "M Models represents you in front of clienteles.": {
    fr: "M Models vous représente devant la clientèle.",
    ja: "M Modelsはクライアントの前であなたを代表します。",
  },
  "M Models handles your bookings.": {
    fr: "M Models gère vos réservations.",
    ja: "M Modelsはあなたの予約を管理します。",
  },
  "M Models Negotiates rates for you with the clientele.": {
    fr: "M Models négocie les tarifs pour vous avec la clientèle.",
    ja: "M Modelsはクライアントとあなたのための料金を交渉します。",
  },
  "What if I have no experience?": {
    fr: "Et si je n'ai pas d'expérience ?",
    ja: "経験がない場合はどうすればよいですか？",
  },
  "Don't worry- we regularly interview industry professionals as well as novice, but we do not represent everyone we see.":
    {
  ...
  "What should I wear to the interview?": {
    fr: "Que dois-je porter pour l'entretien ?",
    ja: "面接には何を着ていけばよいですか？",
  },
  "Remember its a interview you only get one chance to make a first impression.":
    {
  ...
  "Can M Models guarantee me work?": {
    fr: "M Models peut-il me garantir du travail ?",
    ja: "M Modelsは仕事を保証してくれますか？",
  },
  "No! It is ultimately the clients decision to make. M Models assists you to get the auditions and market you as a individual.":
    {
  ...
  "Does M Models find work internationally?": {
    fr: "M Models trouve-t-il du travail à l'international ?",
    ja: "M Modelsは国際的に仕事を見つけますか？",
  },
  "What’s the height requirement?": {
    fr: "Quelle est la taille requise ?",
    ja: "身長の要件は何ですか？",
  },
  ...
  "Additional requirements or special notes...": {
    fr: "Exigences supplémentaires ou notes spéciales...",
    ja: "その他の要件や特記事項...",
  },
  "e.g. Oz": { fr: "ex: Oz", ja: "例：Oz" },
  "e.g. Kahn": { fr: "ex: Kahn", ja: "例：Kahn" },
  ...
  "director@example.com": {
    fr: "directeur@exemple.com",
    ja: "info@example.com",
  },
  "80 Sherbourne Street,": {
    fr: "80 rue Sherbourne,",
    ja: "80 Sherbourne Street,",
  },
  "Suite 104 Toronto,": { fr: "Suite 104 Toronto,", ja: "Suite 104 トロント," },
  "ON M5A 4S9": { fr: "ON M5A 4S9", ja: "オンタリオ州 M5A 4S9" },
  "1300 Britannia Rd East, 2nd Floor": {
    fr: "1300 Britannia Rd East, 2e étage",
    ja: "1300 Britannia Rd East, 2nd Floor",
  },
  "Suite 208, Mississauga,": {
    fr: "Suite 208, Mississauga,",
    ja: "Suite 208, ミシサガ,",
  },
  "ON L4W 1C8": { fr: "ON L4W 1C8", ja: "オンタリオ州 L4W 1C8" },
  "125 9 Avenue SE, Suite #2000": {
    fr: "125 9 Avenue SE, Suite #2000",
    ja: "125 9 Avenue SE, Suite #2000",
  },
  "Calgary, AB, T2G 0P6": {
    fr: "Calgary, AB, T2G 0P6",
    ja: "カルガリー, AB, T2G 0P6",
  },
  "Head Office (Toronto)": {
    fr: "Siège social (Toronto)",
    ja: "本社（トロント）",
  },
  Mississauga: { fr: "Mississauga", ja: "ミシサガ" },
...
function applyLanguage(lang) {
  if (lang === "en") {
    ...
    while ((node = walker.nextNode())) {
      let original =
        node.originalText || node.nodeValue.trim().replace(/\s+/g, " ");
  ...
  $("input[placeholder], textarea[placeholder]").each(function () {
    ...
    if (!$(this).attr("data-orig-placeholder"))
      $(this).attr("data-orig-placeholder", original);
  ...
  if (window.Parsley) {
    window.Parsley.addMessages("fr", {
      ...
      minlength:
        "Cette chaîne est trop courte. Elle doit avoir au moins %s caractères.",
      maxlength:
        "Cette chaîne est trop longue. Elle doit avoir au plus %s caractères.",
...
$(document).ready(function () {
  ...
  $(".filter-btn").click(function (e) {
    ...
    $(".filter-btn")
      ...
      .addClass("text-gray-400 hover:text-gray-900");
    $(this)
      .addClass("text-primary border-b-2 border-primary")
      .removeClass("text-gray-400 hover:text-gray-900");
    const target = $(this).data("target");
    $(".model-grid").addClass("hidden");
    $("#" + target).removeClass("hidden");
    $("#" + target + " .model-card")
      .css({ opacity: 0, marginTop: "20px" })
