...
const i18nDict = {
    'Home': { 'fr': 'Accueil', 'ja': 'ホーム' },
    'News': { 'fr': 'Actualités', 'ja': 'ニュース' },
    'Video': { 'fr': 'Vidéo', 'ja': 'ビデオ' },
    'Models': { 'fr': 'Modèles', 'ja': 'モデル' },
    'Our Clients': { 'fr': 'Nos Clients', 'ja': 'クライアント' },
    'Become a Model': { 'fr': 'Devenir Modèle', 'ja': 'モデルになる' },
    ...
    'Select Your Region': { 'fr': 'Choisissez Votre Région', 'ja': '地域を選択してください' },

    // Home
    'Premier International Representation': { 'fr': 'Représentation Internationale de Premier Plan', 'ja': '最高の国際的な表現' },
    'Defining The': { 'fr': 'Définir', 'ja': 'ファッションの' },
    'Future': { 'fr': 'l\'Avenir', 'ja': '未来' },
    'Of Fashion': { 'fr': 'de la Mode', 'ja': 'を定義する' },
    'Discover the faces that are shaping the global narrative of style, luxury, and art across top fashion capitals.': {
        'fr': 'Découvrez les visages qui façonnent la narration mondiale du style et de l\'art dans les capitales de la mode.',
        'ja': '世界のファッションの中心地で、スタイル、ラグジュアリー、アートのグローバルな物語を形作る顔を発見してください。'
    },
    'View Portfolio': { 'fr': 'Voir le Portfolio', 'ja': 'ポートフォリオを見る' },
    'Inquire Now': { 'fr': 'Se Renseigner', 'ja': 'お問い合わせ' },
    'Our Global Presence': { 'fr': 'Notre Présence Mondiale', 'ja': 'グローバルな展開' },
    'Representing exceptional talent in key markets around the world. We bridge the gap between local culture and global fashion.': {
        'fr': 'Représenter des talents exceptionnels dans les marchés mondiaux clés. Nous faisons le pont entre culture locale et mode mondiale.',
        'ja': '世界中の主要市場で優れた才能を代表し、地域文化とグローバルファッションの架け橋となります。'
    },
    'Canada HQ': { 'fr': 'Siège Canada', 'ja': 'カナダ本部' },
    'West Coast': { 'fr': 'Côte Ouest', 'ja': '西海岸' },
    'Prairies': { 'fr': 'Prairies', 'ja': '大平原' },
    'Asia Pacific': { 'fr': 'Asie-Pacifique', 'ja': 'アジア太平洋' },
    
    'Featured Faces': { 'fr': 'Visages Vedettes', 'ja': '注目の顔' },
    'View All Models': { 'fr': 'Voir Tous les Modèles', 'ja': 'すべてのモデルを見る' },

    // Application Form
    'Application Form': { 'fr': 'Formulaire de Candidature', 'ja': '応募フォーム' },
    'Please fill out the details below to apply. Your requirements may change based on your designation.': { 'fr': 'Veuillez remplir les détails ci-dessous pour postuler. Vos exigences peuvent changer en fonction de votre désignation.', 'ja': '申し込むには以下の詳細を入力してください。 要件は指定によって異なる場合があります。' },
    'What is your designation? *': { 'fr': 'Quelle est votre désignation ? *', 'ja': 'あなたの指定は何ですか？ *' },
    'Select an option that best represents you': { 'fr': 'Sélectionnez une option qui vous représente le mieux', 'ja': 'あなたを最もよく表すオプションを選択してください' },
    'Designer': { 'fr': 'Designer', 'ja': 'デザイナー' },
    'Model': { 'fr': 'Modèle', 'ja': 'モデル' },
    'Volunteer': { 'fr': 'Bénévole', 'ja': 'ボランティア' },
    'First Name *': { 'fr': 'Prénom *', 'ja': '名 *' },
    'Last Name *': { 'fr': 'Nom de Famille *', 'ja': '姓 *' },
    'e.g. Oz': { 'fr': 'ex: Oz', 'ja': '例: Oz' },
    'e.g. Kahn': { 'fr': 'ex: Kahn', 'ja': '例: Kahn' },
    'Street Address *': { 'fr': 'Adresse *', 'ja': '住所 *' },
    'City *': { 'fr': 'Ville *', 'ja': '都市 *' },
    'Postal Code *': { 'fr': 'Code Postal *', 'ja': '郵便番号 *' },
    'Phone *': { 'fr': 'Téléphone *', 'ja': '電話 *' },
    'e.g. 5555555555': { 'fr': 'ex: 5555555555', 'ja': '例: 5555555555' },
    'Upload File': { 'fr': 'Télécharger un Fichier', 'ja': 'ファイルをアップロードする' },
    'Click to upload (Up to 4 files)': { 'fr': 'Cliquez pour télécharger (jusqu\'à 4 fichiers)', 'ja': 'クリックしてアップロード (最大4ファイル)' },
    'Upload Image (Headshot) *': { 'fr': 'Télécharger l\'Image (Portrait) *', 'ja': '画像のアップロード（顔写真） *' },
    'Upload Look Book *': { 'fr': 'Télécharger le Look Book *', 'ja': 'ルックブックをアップロード *' },
    'Apply': { 'fr': 'Postuler', 'ja': '応募する' },
    ...
    'Gender': { 'fr': 'Genre', 'ja': '性別' },
    'Male': { 'fr': 'Homme', 'ja': '男性' },
    'Female': { 'fr': 'Femme', 'ja': '女性' },
    'Age': { 'fr': 'Âge', 'ja': '年齢' },
    'Measurements': { 'fr': 'Mensurations', 'ja': '測定値' },
    'Height': { 'fr': 'Taille', 'ja': '身長' },
    'Chest/Cup': { 'fr': 'Poitrine', 'ja': '胸部' },
    'Waist': { 'fr': 'Taille', 'ja': 'ウエスト' },
    'Hips': { 'fr': 'Hanches', 'ja': 'ヒップ' },
    'Shoe': { 'fr': 'Chaussures', 'ja': '靴のサイズ' },
    'Eyes': { 'fr': 'Yeux', 'ja': '目の色' },
    'Hair': { 'fr': 'Cheveux', 'ja': '髪の色' },
    'Dress': { 'fr': 'Robe', 'ja': 'ドレスのサイズ' },
    'Photos': { 'fr': 'Photos', 'ja': '写真' },
    'Upload Image': { 'fr': 'Télécharger', 'ja': '画像をアップロード' },
    'Submit Application': { 'fr': 'Soumettre', 'ja': '応募する' },

    // Hire a Model
    'Booking': { 'fr': 'Réservation', 'ja': '予約' },
    'Company Name': { 'fr': 'Nom de l\'Entreprise', 'ja': '会社名' },
    'Contact Name': { 'fr': 'Nom du Contact', 'ja': '担当者名' },
    'Project Details': { 'fr': 'Détails du Projet', 'ja': 'プロジェクトの詳細' },
    'Request Booking': { 'fr': 'Demander une Réservation', 'ja': '予約をリクエストする' },
    ...
    'Campaign Highlights': { 'fr': 'Points Forts de la Campagne', 'ja': 'キャンペーンのハイライト' },
    'OUR': { 'fr': 'NOTRE', 'ja': '私たちの' },
    'WORKS': { 'fr': 'RÉALISATIONS', 'ja': '実績' },
    'Our Works': { 'fr': 'Showcase', 'ja': 'ショーケース' },
    'Showcase Campaign Highlights': { 'fr': 'Showcase Points Forts', 'ja': 'ショーケース・キャンペーンハイライト' },
    'This value is required.': { 'fr': 'Ce champ est obligatoire.', 'ja': 'このフィールドは必須です。' },
    'Gallery': { 'fr': 'Galerie', 'ja': 'ギャラリー' },
    'Instagram': { 'fr': 'Instagram', 'ja': 'インスタグラム' },
    'Latest Reels': { 'fr': 'Derniers Reels', 'ja': '最新のリール' },
    'Follow on Instagram': { 'fr': 'Suivez-nous sur Instagram', 'ja': 'Instagramでフォロー' },
    'Trusted By': { 'fr': 'Approuvé Par', 'ja': '信頼の提供先' },
    'Our Clients': { 'fr': 'Nos Clients', 'ja': '私たちのクライアント' },
    ...
    'Here are a few commercials and music videos our models and talents were booked for. If you want to see more videos please visit our': {
        'fr': 'Voici quelques publicités et clips musicaux pour lesquels nos modèles et talents ont été engagés. Si vous souhaitez voir plus de vidéos, veuillez visiter notre',
        'ja': '私たちのモデルやタレントが起用されたCMやミュージックビデオをいくつかご紹介します。他のビデオをご覧になりたい場合は、当社の'
    },
    'YOUTUBE CHANNEL': { 'fr': 'CHAÎNE YOUTUBE', 'ja': 'YOUTUBEチャンネル' },
    'How did you hear about us?': { 'fr': 'Comment avez-vous entendu parler de nous ?', 'ja': '当社のことをどこで知りましたか？' },
    'HOW DID YOU HEAR ABOUT US?': { 'fr': 'COMMENT AVEZ-VOUS ENTENDU PARLER DE NOUS ?', 'ja': '当社のことをどこで知りましたか？' },
    'Billboard': { 'fr': 'Panneau publicitaire', 'ja': '看板' },
    'Friend': { 'fr': 'Ami', 'ja': '友人' },
    'Internet': { 'fr': 'Internet', 'ja': 'インターネット' },
    'Newspaper': { 'fr': 'Journal', 'ja': '新聞' },
    'Radio': { 'fr': 'Radio', 'ja': 'ラジオ' },
    'Scout': { 'fr': 'Recruteur', 'ja': 'スカウト' },
    'Social Media': { 'fr': 'Médias sociaux', 'ja': 'ソーシャルメディア' },
    'TV': { 'fr': 'Télévision', 'ja': 'テレビ' },
    'Other': { 'fr': 'Autre', 'ja': 'その他' },
    'Please specify': { 'fr': 'Veuillez préciser', 'ja': '詳しくご記入ください' },
    'Project Type': { 'fr': 'Type de projet', 'ja': 'プロジェクトの種類' },
    'Casting Breakdown': { 'fr': 'Détails du casting', 'ja': '募集詳細' },
    'Comment': { 'fr': 'Commentaire', 'ja': 'コメント' },
    'Casting Director': { 'fr': 'Directeur de casting', 'ja': 'キャスティングディレクター' },
    'Scripts/Storyboard': { 'fr': 'Scripts/Storyboard', 'ja': '脚本 / 絵コンテ' },
    'Ethnic Appearance': { 'fr': 'Apparence ethnique', 'ja': '民族的外見' },
    'Age Range': { 'fr': 'Tranche d\'âge', 'ja': '年齢層' },
    'Min': { 'fr': 'Min', 'ja': '最小' },
    'Max': { 'fr': 'Max', 'ja': '最大' },
    'Any': { 'fr': 'N\'importe lequel', 'ja': '指定なし' },
    'Hair Length': { 'fr': 'Longueur de cheveux', 'ja': '髪の長さ' },
    'Select Type': { 'fr': 'Sélectionner le type', 'ja': 'タイプを選択' },
    'Commercial': { 'fr': 'Commercial', 'ja': 'コマーシャル' },
    'Editorial': { 'fr': 'Éditorial', 'ja': 'エディトリアル' },
    'Runway': { 'fr': 'Défilé', 'ja': 'ランウェイ' },
    'Fitness': { 'fr': 'Fitness', 'ja': 'フィットネス' },
    'Fitting': { 'fr': 'Essayage', 'ja': 'フィッティング' },
    'Parts': { 'fr': 'Parties du corps', 'ja': 'パーツ' },
    'Male': { 'fr': 'Homme', 'ja': '男性' },
    'Female': { 'fr': 'Femme', 'ja': '女性' },
    'Non-Binary': { 'fr': 'Non-binaire', 'ja': 'ノンバイナリー' },
    'Select Gender': { 'fr': 'Sélectionner le genre', 'ja': '性別を選択' },
    'Black': { 'fr': 'Noir', 'ja': '黒' },
    'Blue': { 'fr': 'Bleu', 'ja': '青' },
    'Brown': { 'fr': 'Brun', 'ja': '茶色' },
    'Green': { 'fr': 'Vert', 'ja': '緑' },
    'Grey': { 'fr': 'Gris', 'ja': 'グレー' },
    'Hazel': { 'fr': 'Noisette', 'ja': 'ヘーゼル' },
    'Auburn': { 'fr': 'Auburn', 'ja': '赤褐色' },
    'Blonde': { 'fr': 'Blond', 'ja': 'ブロンド' },
    'Red': { 'fr': 'Rouge', 'ja': '赤' },
    'Afro': { 'fr': 'Afro', 'ja': 'アフロ' },
    'Bald': { 'fr': 'Chauve', 'ja': '坊主' },
    'Long': { 'fr': 'Long', 'ja': 'ロング' },
    'Medium': { 'fr': 'Moyen', 'ja': 'セミロング' },
    'Short': { 'fr': 'Court', 'ja': 'ショート' },
    'What are the different types of modeling?': { 'fr': 'Quels sont les différents types de mannequinat ?', 'ja': 'モデリングにはどのような種類がありますか？' },
    'Fashion:': { 'fr': 'Mode :', 'ja': 'ファッション：' },
    'These are the models that walk the runway in fashion shows and appear in the fashion magazines like Vogue, Bazaar, Cosmopolitan and Elle. In the U.S., most of this takes place in New York. Certainly most markets have a small amount of fashion happening - but New York City is the fashion capital of the United States. Fashion models account for an extremely small percentage of the total model population in the industry.': {
        'fr': 'Ce sont les mannequins qui défilent lors des défilés de mode et apparaissent dans des magazines comme Vogue. Aux États-Unis, cela se passe principalement à New York. Les mannequins de mode représentent un très faible pourcentage de la population totale de mannequins.',
        'ja': 'これらは、ファッションショーでランウェイを歩き、Vogue、Bazaar、Cosmopolitan、Elleなどのファッション誌に登場するモデルです。米国では、そのほとんどがニューヨークで行われています。ほとんどの市場で少なからずファッションイベントは行われていますが、ニューヨーク市は米国のファッションの中心地です。ファッションモデルは、業界の全モデル人口の極めてわずかな割合を占めています。'
    },
    'Commercial:': { 'fr': 'Commercial :', 'ja': 'コマーシャル：' },
    'This is the biggest modeling category and the one most often overlooked and misunderstood by young models. Commercial models appear in ads, packaging, billboards, and magazine articles for everything from medicine to insurance, from work out equipment to office equipment. This is a category where personality and the ability to show different expressions are equally important as looks. While some are beautiful or handsome - most successful commercial models look like everyday people.': {
        'fr': 'C\'est la plus grande catégorie de mannequinat. Les mannequins commerciaux apparaissent dans les publicités, les emballages et les panneaux publicitaires. C\'est une catégorie où la personnalité est aussi importante que le look.',
        'ja': 'これは最大のモデリングカテゴリーであり、若いモデルに見落とされがちで誤解されやすい分野です。コマーシャルモデルは、医薬品から保険、トレーニング機器から事務機器まで、あらゆるものの広告、パッケージ、看板、雑誌の記事に登場します。これは、容姿と同じくらい個性や異なる表情を見せる能力が重要なカテゴリーです。美しい人やハンサムな人もいますが、成功しているコマーシャルモデルのほとんどは、日常的な人々のように見えます。'
    },
    'Promotional:': { 'fr': 'Promotionnel :', 'ja': 'プロモーション：' },
    'Promotions are how many models actually make a living. Promotional modeling ranges from being hired to hand out free samples of products to staffing trade show booths in large convention halls. This is a category that rarely involves being photographed and is very much about your personality and ability to interact with people.': {
        'fr': 'Les promotions sont la façon dont de nombreux mannequins gagnent leur vie. Cela va de la distribution d\'échantillons gratuits à la tenue de stands dans des salons professionnels.',
        'ja': 'プロモーションは、多くのモデルが実際に生計を立てている方法です。プロモーションモデリングは、製品の無料サンプルを配布するために雇われることから、大規模なコンベンションホールでの見本市のブースに配置されることまで多岐にわたります。これは写真に撮られることがめったになく、あなたの個性や人々と交流する能力が非常に重要となるカテゴリーです。'
    },
    'Glamor:': { 'fr': 'Glamour :', 'ja': 'グラビア：' },
    'Certainly not for everyone - but if you are comfortable with your body and certainly - of legal age - glamour modeling can range anywhere from calendar girl to swimwear catalog model.': {
        'fr': 'Pas pour tout le monde - mais si vous êtes à l\'aise avec votre corps, le mannequinat glamour peut aller de la "calendar girl" au mannequin de catalogue de maillots de bain.',
        'ja': '決して誰にでも向いているわけではありませんが、自分の体に自信があり、もちろん法定年齢に達している場合、グラビアモデリングはカレンダーガールから水着カタログモデルまで多岐にわたります。'
    },
    'What does M Models do for you?': { 'fr': 'Que fait M Models pour vous ?', 'ja': 'M Modelsはあなたのために何をしますか？' },
    'M Models represents you in front of clienteles.': { 'fr': 'M Models vous représente devant la clientèle.', 'ja': 'M Modelsはクライアントの前であなたを代表します。' },
    'M Models handles your bookings.': { 'fr': 'M Models gère vos réservations.', 'ja': 'M Modelsはあなたの予約を管理します。' },
    'M Models Negotiates rates for you with the clientele.': { 'fr': 'M Models négocie les tarifs pour vous avec la clientèle.', 'ja': 'M Modelsはクライアントとあなたのための料金を交渉します。' },
    'What if I have no experience?': { 'fr': 'Et si je n\'ai pas d\'expérience ?', 'ja': '経験がない場合はどうすればよいですか？' },
    'Don\'t worry- we regularly interview industry professionals as well as novice, but we do not represent everyone we see.': {
        'fr': 'Ne vous inquiétez pas - nous interviewons régulièrement des professionnels ainsi que des novices, mais nous ne représentons pas tout le monde.',
        'ja': '心配しないでください。私たちは定期的に業界のプロフェッショナルだけでなく初心者も面接していますが、会う人全員を代表するわけではありません。'
    },
    'What should I wear to the interview?': { 'fr': 'Que dois-je porter pour l\'entretien ?', 'ja': '面接には何を着ていけばよいですか？' },
    'Remember its a interview you only get one chance to make a first impression.': {
        'fr': 'N\'oubliez pas que c\'est un entretien, vous n\'avez qu\'une seule chance de faire une première impression.',
        'ja': 'これは面接であることを忘れないでください。第一印象を良くするチャンスは一度しかありません。'
    },
    'Can M Models guarantee me work?': { 'fr': 'M Models peut-il me garantir du travail ?', 'ja': 'M Modelsは仕事を保証してくれますか？' },
    'No! It is ultimately the clients decision to make. M Models assists you to get the auditions and market you as a individual.': {
        'fr': 'Non ! C\'est finalement la décision du client. M Models vous aide à obtenir des auditions et à vous promouvoir en tant qu\'individu.',
        'ja': 'いいえ！最終的に決めるのはクライアントです。M Modelsは、あなたがオーディションを受けられるようサポートし、個人としてあなたをマーケティングします。'
    },
    'Does M Models find work internationally?': { 'fr': 'M Models trouve-t-il du travail à l\'international ?', 'ja': 'M Modelsは国際的に仕事を見つけますか？' },
    'What’s the height requirement?': { 'fr': 'Quelle est la taille requise ?', 'ja': '身長の要件は何ですか？' },
    'Global Offices': { 'fr': 'Bureaux Mondiaux', 'ja': 'グローバルオフィス' },
    'Send a Message': { 'fr': 'Envoyez un message', 'ja': 'メッセージを送信する' },
    'Your name': { 'fr': 'Votre nom', 'ja': 'お名前' },
    'Your e-mail': { 'fr': 'Votre e-mail', 'ja': 'メールアドレス' },
    'Reason for contact': { 'fr': 'Raison du contact', 'ja': 'お問い合わせの理由' },
    'Write your message...': { 'fr': 'Écrivez votre message...', 'ja': 'メッセージをご記入ください...' },
    'Additional requirements or special notes...': { 'fr': 'Exigences supplémentaires ou notes spéciales...', 'ja': 'その他の要件や特記事項...' },
    'e.g. Oz': { 'fr': 'ex: Oz', 'ja': '例：Oz' },
    'e.g. Kahn': { 'fr': 'ex: Kahn', 'ja': '例：Kahn' },
    'e.g. 5555555555': { 'fr': 'ex: 5555555555', 'ja': '例：09012345678' },
    '+1 (555) 000-0000': { 'fr': '+1 (555) 000-0000', 'ja': '090-0000-0000' },
    'director@example.com': { 'fr': 'directeur@exemple.com', 'ja': 'info@example.com' },
    '80 Sherbourne Street,': { 'fr': '80 rue Sherbourne,', 'ja': '80 Sherbourne Street,' },
    'Suite 104 Toronto,': { 'fr': 'Suite 104 Toronto,', 'ja': 'Suite 104 トロント,' },
    'ON M5A 4S9': { 'fr': 'ON M5A 4S9', 'ja': 'オンタリオ州 M5A 4S9' },
    '1300 Britannia Rd East, 2nd Floor': { 'fr': '1300 Britannia Rd East, 2e étage', 'ja': '1300 Britannia Rd East, 2nd Floor' },
    'Suite 208, Mississauga,': { 'fr': 'Suite 208, Mississauga,', 'ja': 'Suite 208, ミシサガ,' },
    'ON L4W 1C8': { 'fr': 'ON L4W 1C8', 'ja': 'オンタリオ州 L4W 1C8' },
    '125 9 Avenue SE, Suite #2000': { 'fr': '125 9 Avenue SE, Suite #2000', 'ja': '125 9 Avenue SE, Suite #2000' },
    'Calgary, AB, T2G 0P6': { 'fr': 'Calgary, AB, T2G 0P6', 'ja': 'カルガリー, AB, T2G 0P6' },
    'Head Office (Toronto)': { 'fr': 'Siège social (Toronto)', 'ja': '本社（トロント）' },
    'Mississauga': { 'fr': 'Mississauga', 'ja': 'ミシサガ' }
};
...
function applyLanguage(lang) {
    if (lang === 'en') {
        ...
        while ((node = walker.nextNode())) {
            ...
            if (original && i18nDict[original] && i18nDict[original][lang]) {
                node.nodeValue = node.nodeValue.replace(node.nodeValue.trim(), i18nDict[original][lang]);
            }
        }
    }
    
    $('input[placeholder], textarea[placeholder]').each(function() {
        let original = $(this).attr('data-orig-placeholder') || $(this).attr('placeholder');
        if(!$(this).attr('data-orig-placeholder')) $(this).attr('data-orig-placeholder', original);
        
        if (lang !== 'en' && i18nDict[original] && i18nDict[original][lang]) {
            $(this).attr('placeholder', i18nDict[original][lang]);
        } else if (lang === 'en') {
